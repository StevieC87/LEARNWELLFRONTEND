...
export default function DeletePage(props) {
  ...
  const doDeletePage = async () => {
    ...
    const url = `${process.env.NEXT_PUBLIC_API_URL}/pagesposts/schema/${pageid}?pagetype=${pagetype}`;
  ...
  return (
    <>
      ...
      <ModalYesNo
        textchoice={`Are you sure you want to permanently delete this ${pagetype} to trash?`}
        isOpen={showModal}
