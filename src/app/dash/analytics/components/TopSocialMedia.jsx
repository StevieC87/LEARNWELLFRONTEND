...
export default function TopSocialMedia(props) {
      ...
      try {
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/analytics/gettrafficsearchengine`, {
          ...
          body: JSON.stringify({
            ...
            searchorsocial: 'social', // Specify that we want search engines data
          }),
        ...
        setTopsocialMedia(data.socialMediatop || []);
    ...
    <>
      <div className="referralsdiv">
        ...
        <div className="referralstuff">
          {topsocialMedia && topsocialMedia.map((referrer, index) => (
            <div key={index}
