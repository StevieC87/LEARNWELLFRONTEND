...
function svgMapWrapper(svgPanZoom) {
    ...
    var defaultOptions = {
      ...
      onGetTooltip: function (tooltipDiv, countryID, countryValues) {
        tooltipDiv.innerHTML = `
          <div class="svgMap-tooltip  svgMap-tooltip-content-container">
            <strong>Country:</strong> ${countryID}<br/>
            <strong>Visitors:</strong> ${countryValues}
          </div>
        `;
        return tooltipDiv;
        // return null;
  ...
  svgMap.prototype.createMap = function () {
    ...
    this.mapImage.addEventListener("dblclick", (e) => {
      // alert("123");
      e.preventDefault();
    });
    ...
    this.mapPanZoom = svgPanZoom(this.mapImage, {
      //! EDITED HERE zoomenabled and preventousaeenesdefault
      zoomEnabled: false,
      fit: true,
      center: true,
  ...
  svgMap.prototype.error = function (error) {
    (console.log || console.log)("svgMap error: " + (error || "Unknown error"));
  };
