...
const Datepicker = React.forwardRef((props, ref) => {
  ...
  const { dateprop, onDateChange, closedialogCallback, multipleprop, format, weekstartssunday, open } = props;
  const [isOpen, setIsOpen] = useState(open || false); // open prop to control dialog visibility
    ...
    <>
      ...
      <div className="datepickerwrapper" >
        ...
        <div className="datepickerformgroupdiv" onClick={() => setIsOpen(true)}>
          ...
          />
          <svg
            id="calendaricon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-calendar3 bi inputicon calendarsvgdatepicker" viewBox="0 0 16 16">
